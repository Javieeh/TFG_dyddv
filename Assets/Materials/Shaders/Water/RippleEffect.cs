...
public class RippleEffect : MonoBehaviour
{
    ...
    //{
    //    // Verifica si la colisión ocurrió con el objeto específico con el que quieres activar las partículas
    //    if (collision.gameObject.CompareTag("Player"))
    //    {
    //        // Obtiene la posición de la colisión para emitir las partículas en ese punto
